...
@Index("IXINFOEMPRDIVI01", ["emprEmpr", "diviDivi", "inedAnno", "inedMes"], {
  unique: true,
})
@Index("PK_AUCO_INFOEMPRDIVI", ["inedId"], { unique: true })
@Entity("AUCO_INFOEMPRDIVI")
export class entityVerificacion {
