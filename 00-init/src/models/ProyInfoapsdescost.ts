...
@Index(
  "IXPROY_INFOAPSDESCOST01",
  ["proyId", "apsaId", "descAnno", "descMes", "paraCosto20010"],
  { unique: true }
)
@Index("PK_PROY_INFOAPSDESCOST", ["descId"], { unique: true })
@Entity("PROY_INFOAPSDESCOST")
export class ProyInfoapsdescost {
