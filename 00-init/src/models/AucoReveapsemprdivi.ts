...
@Index(
  "IXAUCO_REVEAPSEMPRDIVI01",
  ["iaedId", "apsaId", "emprEmpr", "diviDivi", "iaedAnno", "iaedMes"],
  { unique: true }
)
@Index("PK_AUCO_REVEAPSEMPRDIVI", ["reveId", "iaedId"], { unique: true })
@Entity("AUCO_REVEAPSEMPRDIVI")
export class AucoReveapsemprdivi {
