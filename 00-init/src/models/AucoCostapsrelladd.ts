...
@Index("PK_TAR_COSTAPSRELLADD", ["costId"], { unique: true })
@Entity("AUCO_COSTAPSRELLADD")
export class AucoCostapsrelladd {
  ...
  @ManyToOne(
    () => AucoApsrelleno,
    (aucoApsrelleno) => aucoApsrelleno.aucoCostapsrelladds
  )
  @JoinColumn([
