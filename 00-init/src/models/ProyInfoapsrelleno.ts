...
@Index(
  "IXPROY_INFOAPSRELLENO01",
  ["proyId", "apsaId", "rellId", "iareAnno", "iareMes"],
  { unique: true }
)
@Index("PK_PROY_INFOAPSRELLENO", ["iareId", "proyId"], { unique: true })
@Entity("PROY_INFOAPSRELLENO")
export class ProyInfoapsrelleno {
  @Column("date", {
