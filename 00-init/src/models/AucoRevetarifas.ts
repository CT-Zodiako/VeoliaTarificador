...
@Entity("AUCO_REVETARIFAS")
export class AucoRevetarifas {
  ...
  @Column("number", { primary: true, name: "TARI_ANNO" })
  tariAnno: number;

  @Column("number", { primary: true, name: "TARI_MES" })
  tariMes: number;
