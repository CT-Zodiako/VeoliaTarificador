...
@Index(
  "IX_PROY_INFOEMPRDIVI01",
  ["proyId", "apsaId", "emprEmpr", "diviDivi", "inedAnno", "inedMes"],
  { unique: true }
)
@Index("PK_PROY_INFOEMPRDIVI", ["inedId", "proyId"], { unique: true })
@Entity("PROY_INFOEMPRDIVI")
export class ProyInfoemprdivi {
