...
@Index(
  "IXPROY_INFOAPSEMPRDIVI01",
  ["proyId", "apsaId", "emprEmpr", "diviDivi", "iaedAnno", "iaedMes"],
  { unique: true }
)
@Index("PK_PROY_INFOAPSEMPRDIVI", ["iaedId", "proyId"], { unique: true })
@Entity("PROY_INFOAPSEMPRDIVI")
export class ProyInfoapsemprdivi {
